...
import type { StoredDevice, SafetyNumberEntry } from '../types'
import type { ChatDeviceSession, ChatSummary, PrekeyDeviceBundle, RecipientDevice } from '../lib/api'
import {
...
import { persistStoredDevice } from '../utils/storage'
import { toSafetyNumberEntry } from '../utils/safety-helpers'
import { toLocalSessionDeviceMaterial } from '../utils/crypto-helpers'
...
export function useChatSessions(params: UseChatSessionsParams) {
  ...
  const { view, chatItems, deferredActiveChatId, activeChatId, activeChatIdRef } = params
