...
import { mergeCallSignals, readMembraneNativeEventType, pickDominantRemoteSpeakerEndpointId, pickFeaturedRemoteTrack } from '../utils/call-helpers'
...
export function useCall(params: UseCallParams) {
  const { storedDevice, setBanner, setLoading } = useAppContext()
  const { view, deferredActiveChatId, activeChatId } = params
  ...
  return {
    ...
    membraneClientReady,
    membraneClientConnected,
    membraneRemoteEndpointCount,
    membraneRemoteTrackCount,
    membraneReadyTrackCount,
    membraneReadyAudioTrackCount,
    membraneReadyVideoTrackCount,
    membraneRemoteEndpointIds,
    membraneRemoteTrackIds,
    membraneRemoteEndpoints,
    membraneRemoteTracks,
    membraneClientEndpointId,
    dominantRemoteEndpointId,
    featuredRemoteTrack,
    resetMembraneClient,
    resetWebRtcLab,
    handleStartCall,
    ...
    handleRotateCallKeyEpoch,
    handleLeaveActiveCall,
    handleProvisionMembraneWebRtcEndpoint,
    handlePollMembraneWebRtcEndpoint,
    handlePingMembraneWebRtcEndpoint,
    handleInitializeWebRtc,
    handleAttachLocalMedia,
    handleReleaseLocalMedia
  }
}
